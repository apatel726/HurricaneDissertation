...
from hurricane_ai import LSTM_TD_MODEL, LSTM_TD_MODEL_HIST


class LstmHurricaneModel:
    """
    ...
    def train(self, X_train, y_train, batch_size=5000, epochs=50, load_if_exists=True, verbose=True) -> dict:
        ...
        weight_file = LSTM_TD_MODEL.format(self.predicted_var)
        history_file = LSTM_TD_MODEL_HIST.format(self.predicted_var)
